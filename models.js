module.exports = {
  ...
  education: [
    {
      ...
      description:   "I'm currently attending the third year of Computer Engineering, where I completed the following core courses: Information Technology 2, Databases 2, Industrial Automation, Software Engineering, Statistics 2, Management Control Systems."
    }, {
      title:         'IIS G. Marconi',
  ...
  coding: [
    {
      ...
      title: '!remindme',
      description: 'A reddit-like reminder bot for Telegram.<br/>You can reply to a Telegram message with “!remindme 2h 5m” and the bot will remind you that message (with a link to it) in two hours and five minutes. As you might have guessed, I really like reddit and Telegram :)',
      link: {
  ...
  photography: [
    {
      image: {
        path: '/content/images/church.jpg',
      ...
      image: {
        path: '/content/images/ship.jpg',
        alt: 'The MV Plassy, Inisheer',
        description: 'The MV Plassy, Inisheer'
      },
      link: {
      ...
      image: {
        path: '/content/images/guitar2.jpg',
